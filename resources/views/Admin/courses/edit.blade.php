...
@section('title', 'Editar Curso | '.config('shop.business.name'))
  ...
  <form class="mt-6 grid gap-6" method="POST" action="{{ route('admin.courses.update', $course) }}" enctype="multipart/form-data">
    ...
    <div>
      ...
      <div class="wysiwyg mt-2" data-wysiwyg>
        ...
        @php
          $descriptionValue = \App\Support\SafeHtml::sanitize(old('description', $course->description));
        @endphp
    ...
    @php
      ...
      $syllabusValue = \App\Support\SafeHtml::sanitize($syllabusValue);
    @endphp
